...
import { SiMongodb, SiLeetcode, SiJavascript } from "react-icons/si";
        ...
        <div className="flex flex-col md:flex-row gap-16 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 mt-8">
              {[
                ...
                { icon: <SiLeetcode className="text-orange-500 text-xl" />, text: "LeetCode" },
              ].map((item, index) => (
                <motion.div
                  key={index}
          ...
          >
            ...
            >
              ...
              I'm Tabish Javed — a passionate full-stack developer who crafts
              digital experiences with clean UI, elegant logics.
            </motion.p>
            ...
            >
              ...
              <p className="text-lg leading-relaxed">
                When I'm not building apps, you'll find me sharpening my
                problem-solving skills — I've solved{" "}
                <span className="font-semibold">200+ problems</span> on LeetCode.
              </p>
            </motion.div>
